...
import com._4ng.enocean.enj.eep.eep26.attributes.EEP26HumidityLinear;
import com._4ng.enocean.enj.eep.eep26.attributes.EEP26TemperatureLinear;
 ...
 * @author bonino
 */
public class SimpleTemperatureAndHumidityListener implements EEPAttributeChangeListener {

    private static final Logger logger = LoggerFactory.getLogger(SimpleTemperatureAndHumidityListener.class);
    ...
    public void handleAttributeChange(int channelId, EEP26Telegram telegram, EEPAttribute<?> attribute, EnOceanDevice device) {
        if (attribute instanceof EEP26TemperatureLinear) {
            logger.info("Received temperature: {} {}", ((EEP26TemperatureLinear) attribute).getValue(), attribute.getUnit());
        }
        else if (attribute instanceof EEP26HumidityLinear) {
            logger.info("Received humidity: {} {}", ((EEP26HumidityLinear) attribute).getValue(), attribute.getUnit());
        }
