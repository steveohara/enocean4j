...
import com._4ng.enocean.enj.eep.eep26.attributes.EEP26PowerMeasurement;
...
public class SimplePowerListener implements EEPAttributeChangeListener {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SimplePowerListener.class);
    ...
    public void handleAttributeChange(int channelId, EEP26Telegram telegram, EEPAttribute<?> attribute, EnOceanDevice device) {
        if (attribute instanceof EEP26PowerMeasurement) {
            logger.debug("Received power: {} {}", ((EEP26PowerMeasurement) attribute).getValue(), attribute.getUnit());
        }
    }
