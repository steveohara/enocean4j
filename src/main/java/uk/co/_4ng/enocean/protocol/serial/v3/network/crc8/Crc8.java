...
package uk.co._4ng.enocean.protocol.serial.v3.network.crc8;

/**
 * Class to calculate the correction code for an input byte vector
 * <p>
 * The polinomial G(x) = x^8 + x^2 + x + 1
 *
 * @author andreabiasi
 */
public class Crc8 {
    ...
    /**
     * Calculate the CRC for the byte array
