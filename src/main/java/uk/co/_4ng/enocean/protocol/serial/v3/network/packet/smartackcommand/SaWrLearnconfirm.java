...
public class SaWrLearnconfirm extends ESP3Packet {
     ...
     *                                Learn OUT: 0x20
     * @param postmasterCandidateID : Device ID of the used Post master
     * @param sartackClientID       : Device ID of the learned IN/OUT Smart Ack Client
     */
    public SaWrLearnconfirm(int responseTime, byte confirmCode, byte[] postmasterCandidateID, byte sartackClientID) {
