 ...
 * @author bonino
 */
public class A50217 extends A502 {
    ...
    public A50217() {
        ...
        // add attributes A50217 has operative range between 10.0 and 90.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(10.0, 90.0));
    }
}
