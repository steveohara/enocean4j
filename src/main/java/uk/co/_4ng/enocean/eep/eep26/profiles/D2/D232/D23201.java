...
/**
 * Implementation of a duel phase current clamp
 * @author sohara
 */
public class D23201 extends D23200 {

    /**
     * Duel channel CT Clamp
     */
    public D23201() {
        addChannelAttribute(1, new EEP26Current(4095));
    }

    @Override
    public boolean handleProfileUpdate(DeviceManager deviceManager, EEP26Telegram telegram, EnOceanDevice device) {
        return handleProfileUpdate(deviceManager, telegram, device, 2);
    }
