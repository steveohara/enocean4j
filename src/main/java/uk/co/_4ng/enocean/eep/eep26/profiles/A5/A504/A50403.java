 ...
 * @author bonino
 */
public class A50403 extends A504 {
    // the used channel
    ...
    public A50403() {
        ...
        addChannelAttribute(CHANNEL, new EEP26TemperatureLinear(1023, -20.0, 60.0));

        // and between 0 and 100% humidity
        addChannelAttribute(CHANNEL, new EEP26HumidityLinear(255, 0.0, 100.0));
    }
}
