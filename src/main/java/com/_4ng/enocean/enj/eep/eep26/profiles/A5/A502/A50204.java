 ...
 * @author bonino
 */
public class A50204 extends A502 {
    ...
    public A50204() {
        ...
        // add attributes A50205 has operative range between -10.0 and 30.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(-10.0, 30.0));
    }
