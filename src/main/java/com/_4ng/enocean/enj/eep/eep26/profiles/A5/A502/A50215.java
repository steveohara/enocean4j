 ...
 * @author bonino
 */
public class A50215 extends A502 {

    // the type definition
    public static final byte type = (byte) 0x15;
    // the used channel
    ...
    public A50215() {
        ...
        // add attributes A50215 has operative range between -60.0 and 20.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(-10.0, 70.0));
    }
