 ...
 * @author bonino
 */
public class A50203 extends A502 {
    ...
    public A50203() {
        ...
        // add attributes A50203 has operative range between -20.0 and 20.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(-20.0, 20.0));
    }
