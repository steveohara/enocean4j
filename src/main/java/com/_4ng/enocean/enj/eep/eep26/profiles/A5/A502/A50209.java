 ...
 * @author bonino
 */
public class A50209 extends A502 {
    ...
    public A50209() {
        ...
        // add attributes A50209 has operative range between 40.0 and 80.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(40.0, 80.0));
    }
