 ...
 * @author bonino
 */
public class A50210 extends A502 {

    // the type definition
    public static final byte type = (byte) 0x10;
    ...
    public A50210() {
        ...
        // add attributes A50210 has operative range between -60.0 and 20.0
        // Celsius
        addChannelAttribute(CHANNEL, new EEP26TemperatureInverseLinear(-60.0, 20.0));
    }
